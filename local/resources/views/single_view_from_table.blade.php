...
@section('single_view_from_table')

                        {{--@if(Storage::disk('local')->has($p->title.'.jpg'))--}}
                            {{--<img  width="400" height="300" src="{{route('get.image',['filename'=>$p->title.'.jpg'])}}" >--}}
                        {{--@endif--}}
                    ...
                    <div class="latest_newsarea">
                        ...
                        <ul id="ticker01" class="news_sticker">
                            ...
                            @foreach($all_posts as $p )
                                @if(Storage::disk('local')->has($p->title.'.jpg'))
                                    <li><a href="{{route('single_view_from_table',['id'=>$p->id])}}"><img src="{{route('get.image',['filename'=>$p->title.'.jpg'])}}"  alt="">{{$p->title}}</a></li>
                                @else
                                    <li><a href="{{route('single_view_from_table',['id'=>$p->id])}}"><img src="{{$p->image}}"  alt="">{{$p->title}}</a></li>
                                @endif
                            @endforeach
                        </ul>
                        {{--SOCIAL--}}
                    ...
                    <div class="left_content">
                        <div class="single_page">
                            <ol class="breadcrumb">
                                ...
                                @foreach($sections_posts as $sec_pos)
                                <li><a href="#">{{$sec_pos->section}}</a></li>
                                <li class="active">{{$sec_pos->title}}</li>
                                    @endforeach
                            </ol>
                                  @foreach($post as $p)
                                <h1>
                                    <?= $p->title?>
                                        ...
                                        <div class="post_commentbox">
                                            ...
                                            @foreach($sections_posts as $sec_pos)
                                            <a href="#"><i class="fa fa-tags"></i>{{$sec_pos->section}}</a>
                                            @endforeach
                                        </div>
                                        <div class="single_page_content">
                                            @if (Auth::check())
                                                <a href="{{route('destroy.post', ['id'=> $p->id ])}}">Delete</a>
                                                <a href="{{route('edit.post',['id'=>$p->id])}}">Edit</a>
                                            @endif
                                                @if(Storage::disk('local')->has($p->title.'.jpg'))
                                                    <img class="img-center" src="{{route('get.image',['filename'=>$p->title.'.jpg'])}}" alt="img">
                                                ...
                                                @else
                                                    <img class="img-center" src="{{$p->image}}" alt="img">
                    ...
                    <aside class="right_content">
                        ...
                        <div class="single_sidebar">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane" id="video">
                                    <div class="vide_area">
                                        <iframe width="100%" height="250" src="http://www.youtube.com/embed/t7Ur_sqOvAs?feature=player_detailpage" frameborder="0" allowfullscreen></iframe>
                                    </div>
                                </div>
                                <div role="tabpanel" class="tab-pane" id="comments">
                                    <ul class="spost_nav">
